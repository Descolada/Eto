	...
	public class ScreenHandler : WidgetHandler<NSScreen, Screen>, Screen.IHandler
	{
		...
		Bitmap CaptureImageWithFilter(RectangleF rect)
		{
			...
			try
			{
				...
				var sourceRect = new RectangleF(rect.X - Bounds.X, rect.Y - Bounds.Y, rect.Width, rect.Height);
				...
				Messaging.void_objc_msgSend_CGRect(configuration, SetSourceRectSelector, sourceRect.ToNS());
		...
		static Bitmap CaptureImageInRect(RectangleF rect)
		{
